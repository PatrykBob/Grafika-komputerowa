...
void GenerateTextures()
{
	...
	error = load_targa("sat0fds1.tga", width, height, format, type, pixels);
	// błąd odczytu pliku
	if (error == GL_FALSE)
	{
...
int main(int argc, char *argv[])
{
	...
	glutAddMenuEntry("Saturn", VENUS_TEX);
	glutAddMenuEntry("Saturn", EARTH_TEX);
	glutAddMenuEntry("Saturn", MARS_TEX);
